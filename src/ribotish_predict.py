...
#   https://github.com/zhpn1024/ribotish/blob/master/src/run/predict.py
# This version is slightly modified to run the PSite pipeline.
###############################################################################

from ribotish.zbio import gtf, bam, stat, exp, tools, orf, fa, interval, io
import ribotish_ribo as ribo
...
def run(args):
  ...
  # mt1022: ignore potential ribopara files
  riboffdict = [None] * len(args.ribobampaths)  # find_offset(args.ribobampaths, args.ribopara)
